...
public class ForgotPasswordController {
    ...
    //1.Send mail for email verification
    @PostMapping("/verifyMail/{email}")
    public ResponseEntity<String> verifyEmail(@PathVariable String email) {
        User user = userRepository.findByEmail(email)
                .orElseThrow(() -> new UserNotFoundException("Please provide valid email!"));

        //formulated the Mail body
    ...
    //Enter the otp wla part and taking email as a Path Variable
    ...
    public ResponseEntity<String> verifyOtp(@PathVariable Integer otp, @PathVariable String email) {
        ...
        // Checking the expiration Time of otp and before here is like
